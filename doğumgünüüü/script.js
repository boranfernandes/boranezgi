...
const messages = [
    ...
    "12.06.2022",
    "Tüm Doğum Günlerinde birlikte olalım güzelimm",
    "Yavrumm :)))",
    "Bu dunya icin fazla iyisin guzelimmmmm"
];
...
function createBalon() {
    ...
    balon.style.backgroundColor = 'transparent'; // Arka plan rengini kaldırdık
...
function showExplosion(balon) {
    ...
    explosion.classList.add('explosion'); // Patlama sınıfını doğru ayarlayın
